...
class aging_cache_db(osv.osv):
    _name = 'ar.aging.cache.db'
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'ar_aging_cache_db')
        #raise ValueError ("data[0]['company_id'][0]")
        #com_id=data[0]['company_id'][0]
        cr.execute("""
...
class ARAgingReport(object):
    ...
    def generate(self):
        ...
        self.sheet.write(0, 1, 'Customer Name', self.style)
        ...
        sobj = self.pool.get('ar.aging.cache')
